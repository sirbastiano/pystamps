...
def test_ralph_completion_guard_accepts_green_stage2_manifest_compare() -> None:
    ...
    assert module.completion_is_allowed("US-008", log_text)


def test_ralph_completion_guard_rejects_green_compare_with_wrong_artifacts() -> None:
    module = _load_guard_module()
    log_text = (
    ...
    assert not module.completion_is_allowed("US-008", log_text)


def test_ralph_completion_guard_rejects_red_stage2_manifest_compare() -> None:
    module = _load_guard_module()
    log_text = (
...
def test_ralph_completion_guard_rejects_short_stage2_manifest_compare() -> None:
    module = _load_guard_module()
    log_text = (
